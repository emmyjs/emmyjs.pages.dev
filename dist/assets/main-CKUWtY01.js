...
<Route href='/documentation/vite' to='Vite'></Route>`});function Kt(e){return{current:e}}function en({el:e}){return e.className="flex flex-col justify-between items-center text-center w-full gap-6",N`
  ...
  `}O(vn,"Footer");document.querySelectorAll("emmy-footer").forEach(e=>{e.connectedCallback()});function bn({el:e}){const[t,n]=e.useState([]);return e.useEffect(async()=>{const o=await(await fetch("https://raw.githubusercontent.com/emmyjs/emmy-dom/refs/heads/main/docs/feature-status.json")).json();n(o.features)},["didMount"]),()=>t().length===0?N`
        <p class='text-lg'>Loading status...</p>
      `:N`
      <ul role='list' class='max-w-lg w-full divide-y divide-gray-200 dark:divide-gray-700'>
        ${t().map(o=>N`<Row status='${o.status}'>${o.name}</Row>`).join("")}
        <Row status='experimental'>CLI create-emmy</Row>
      </ul>
    `}O(bn,"FeatureList");document.querySelectorAll("emmy-featurelist").forEach(e=>{e.connectedCallback()});function pe(e,t){if(!(e instanceof t))throw new TypeError("Cannot call a class as a function")}function wn(e,t){for(var n=0;n<t.length;n++){var o=t[n];o.enumerable=o.enumerable||!1,o.configurable=!0,"value"in o&&(o.writable=!0),Object.defineProperty(e,o.key,o)}}function fe(e,t,n){return t&&wn(e.prototype,t),e}function Ee(e){return+e.replace(/px/,"")}function xn(e){var t=window.devicePixelRatio,n=getComputedStyle(e),o=Ee(n.getPropertyValue("width")),r=Ee(n.getPropertyValue("height"));e.setAttribute("width",(o*t).toString()),e.setAttribute("height",(r*t).toString())}function _(e,t){var n=arguments.length>2&&arguments[2]!==void 0?arguments[2]:0,o=Math.random()*(t-e)+e;return Math.floor(o*Math.pow(10,n))/Math.pow(10,n)}function Ae(e){return e[_(0,e.length)]}var Cn=.00125,jn=5e-4,Sn=9e-4,kn=1e-5,En=6,An=80,qn=.9,Fn=1.7,Tn=.2,Ln=.6,In=.03,Rn=.07,qe=15,Fe=82,On=150,Mn=100,Nn=250,Dn=40,_n=["#fcf403","#62fc03","#f4fc03","#03e7fc","#03fca5","#a503fc","#fc03ad","#fc03c2"];function Te(e){var t=1920;return Math.log(e)/Math.log(t)}var Le=function(){function e(t){pe(this,e);var n=t.initialPosition,o=t.direction,r=t.confettiRadius,a=t.confettiColors,i=t.emojis,s=t.emojiSize,l=t.canvasWidth,u=_(qn,Fn,3),c=u*Te(l);this.confettiSpeed={x:c,y:c},this.finalConfettiSpeedX=_(Tn,Ln,3),this.rotationSpeed=i.length?.01:_(In,Rn,3)*Te(l),this.dragForceCoefficient=_(jn,Sn,6),this.radius={x:r,y:r},this.initialRadius=r,this.rotationAngle=o==="left"?_(0,.2,3):_(-.2,0,3),this.emojiSize=s,this.emojiRotationAngle=_(0,2*Math.PI),this.radiusYUpdateDirection="down";var d=o==="left"?_(Fe,qe)*Math.PI/180:_(-qe,-Fe)*Math.PI/180;this.absCos=Math.abs(Math.cos(d)),this.absSin=Math.abs(Math.sin(d));var h=_(-On,0),p={x:n.x+(o==="left"?-h:h)*this.absCos,y:n.y-h*this.absSin};this.currentPosition=Object.assign({},p),this.initialPosition=Object.assign({},p),this.color=i.length?null:Ae(a),this.emoji=i.length?Ae(i):null,this.createdAt=new Date().getTime(),this.direction=o}return fe(e,[{key:"draw",value:function(n){var o=this.currentPosition,r=this.radius,a=this.color,i=this.emoji,s=this.rotationAngle,l=this.emojiRotationAngle,u=this.emojiSize,c=window.devicePixelRatio;a?(n.fillStyle=a,n.beginPath(),n.ellipse(o.x*c,o.y*c,r.x*c,r.y*c,s,0,2*Math.PI),n.fill()):i&&(n.font="".concat(u,"px serif"),n.save(),n.translate(c*o.x,c*o.y),n.rotate(l),n.textAlign="center",n.fillText(i,0,0),n.restore())}},{key:"updatePosition",value:function(n,o){var r=this.confettiSpeed,a=this.dragForceCoefficient,i=this.finalConfettiSpeedX,s=this.radiusYUpdateDirection,l=this.rotationSpeed,u=this.createdAt,c=this.direction,d=o-u;if(r.x>i&&(this.confettiSpeed.x-=a*n),this.currentPosition.x+=r.x*(c==="left"?-this.absCos:this.absCos)*n,this.currentPosition.y=this.initialPosition.y-r.y*this.absSin*d+Cn*Math.pow(d,2)/2,this.rotationSpeed-=this.emoji?1e-4:kn*n,this.rotationSpeed<0&&(this.rotationSpeed=0),this.emoji){this.emojiRotationAngle+=this.rotationSpeed*n%(2*Math.PI);return}s==="down"?(this.radius.y-=n*l,this.radius.y<=0&&(this.radius.y=0,this.radiusYUpdateDirection="up")):(this.radius.y+=n*l,this.radius.y>=this.initialRadius&&(this.radius.y=this.initialRadius,this.radiusYUpdateDirection="down"))}},{key:"getIsVisibleOnCanvas",value:function(n){return this.currentPosition.y<n+Mn}}]),e}();function Pn(){var e=document.createElement("canvas");return e.style.position="fixed",e.style.width="100%",e.style.height="100%",e.style.top="0",e.style.left="0",e.style.zIndex="1000",e.style.pointerEvents="none",document.body.appendChild(e),e}function Hn(e){var t=e.confettiRadius,n=t===void 0?En:t,o=e.confettiNumber,r=o===void 0?e.confettiesNumber||(e.emojis?Dn:Nn):o,a=e.confettiColors,i=a===void 0?_n:a,s=e.emojis,l=s===void 0?e.emojies||[]:s,u=e.emojiSize,c=u===void 0?An:u;return e.emojies&&console.error("emojies argument is deprecated, please use emojis instead"),e.confettiesNumber&&console.error("confettiesNumber argument is deprecated, please use confettiNumber instead"),{confettiRadius:n,confettiNumber:r,confettiColors:i,emojis:l,emojiSize:c}}var Wn=function(){function e(t){var n=this;pe(this,e),this.canvasContext=t,this.shapes=[],this.promise=new Promise(function(o){return n.resolvePromise=o})}return fe(e,[{key:"getBatchCompletePromise",value:function(){return this.promise}},{key:"addShapes",value:function(){var n;(n=this.shapes).push.apply(n,arguments)}},{key:"complete",value:function(){var n;return this.shapes.length?!1:((n=this.resolvePromise)===null||n===void 0||n.call(this),!0)}},{key:"processShapes",value:function(n,o,r){var a=this,i=n.timeDelta,s=n.currentTime;this.shapes=this.shapes.filter(function(l){return l.updatePosition(i,s),l.draw(a.canvasContext),r?l.getIsVisibleOnCanvas(o):!0})}}]),e}(),zn=function(){function e(){var t=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{};pe(this,e),this.activeConfettiBatches=[],this.canvas=t.canvas||Pn(),this.canvasContext=this.canvas.getContext("2d"),this.requestAnimationFrameRequested=!1,this.lastUpdated=new Date().getTime(),this.iterationIndex=0,this.loop=this.loop.bind(this),requestAnimationFrame(this.loop)}return fe(e,[{key:"loop",value:function(){this.requestAnimationFrameRequested=!1,xn(this.canvas);var n=new Date().getTime(),o=n-this.lastUpdated,r=this.canvas.offsetHeight,a=this.iterationIndex%10===0;this.activeConfettiBatches=this.activeConfettiBatches.filter(function(i){return i.processShapes({timeDelta:o,currentTime:n},r,a),a?!i.complete():!0}),this.iterationIndex++,this.queueAnimationFrameIfNeeded(n)}},{key:"queueAnimationFrameIfNeeded",value:function(n){this.requestAnimationFrameRequested||this.activeConfettiBatches.length<1||(this.requestAnimationFrameRequested=!0,this.lastUpdated=n||new Date().getTime(),requestAnimationFrame(this.loop))}},{key:"addConfetti",value:function(){for(var n=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},o=Hn(n),r=o.confettiRadius,a=o.confettiNumber,i=o.confettiColors,s=o.emojis,l=o.emojiSize,u=this.canvas.getBoundingClientRect(),c=u.width,d=u.height,h=d*5/7,p={x:0,y:h},m={x:c,y:h},g=new Wn(this.canvasContext),f=0;f<a/2;f++){var v=new Le({initialPosition:p,direction:"right",confettiRadius:r,confettiColors:i,confettiNumber:a,emojis:s,emojiSize:l,canvasWidth:c}),b=new Le({initialPosition:m,direction:"left",confettiRadius:r,confettiColors:i,confettiNumber:a,emojis:s,emojiSize:l,canvasWidth:c});g.addShapes(v,b)}return this.activeConfettiBatches.push(g),this.queueAnimationFrameIfNeeded(),g.getBatchCompletePromise()}},{key:"clearCanvas",value:function(){this.activeConfettiBatches=[]}},{key:"destroyCanvas",value:function(){this.canvas.remove()}}]),e}();hljs.highlightAll();const Vn=new zn;Vn.addConfetti();
